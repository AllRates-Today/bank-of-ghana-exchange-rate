// Bank of Ghana exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bog';
...
/** Latest rate for one pair, e.g. getRate('USD', 'GHS', { apiKey }). */
